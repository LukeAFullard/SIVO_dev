...
def main():
    ...
    dashboard = SivoDashboard(title="Global Server Status", columns=4, template="dark_grid")
    ...
    '''
    dashboard.add_html_block("live_feed", header_html, col_span=4)
    ...
    dashboard.add_sivo_block("global_network", world_map, col_span=3)
