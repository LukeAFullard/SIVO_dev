...
def main():
    ...
    sivo1 = Sivo.from_string('<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200"><image href="https://upload.wikimedia.org/wikipedia/commons/4/47/PNG_transparency_demonstration_1.png" x="0" y="0" width="200" height="200" id="img1" class="sivo-floating-element"/></svg>', render_mode="svg", theme="transparent", lock_canvas=True, disable_zoom_controls=True)
    ...
    sivo2 = Sivo.from_string('<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200"><image href="https://upload.wikimedia.org/wikipedia/commons/4/47/PNG_transparency_demonstration_1.png" x="0" y="0" width="200" height="200" id="img2" class="sivo-floating-element"/></svg>', render_mode="svg", theme="transparent", lock_canvas=True, disable_zoom_controls=True)
    ...
    sivo3 = Sivo.from_string('<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200"><image href="https://upload.wikimedia.org/wikipedia/commons/4/47/PNG_transparency_demonstration_1.png" x="0" y="0" width="200" height="200" id="img3" class="sivo-floating-element"/></svg>', render_mode="svg", theme="transparent", lock_canvas=True, disable_zoom_controls=True)
    ...
    sivo4 = Sivo.from_string('<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200"><image href="https://upload.wikimedia.org/wikipedia/commons/4/47/PNG_transparency_demonstration_1.png" x="0" y="0" width="200" height="200" id="img4" class="sivo-floating-element"/></svg>', render_mode="svg", theme="transparent", lock_canvas=True, disable_zoom_controls=True)
