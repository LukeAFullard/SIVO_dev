...
def main():
    ...
    # Note: Setting default_panel_position="right" to match typical visual expectations if panels were added,
    # even though this specific example only uses tooltips.
    sivo_app = Sivo.from_string(svg_string, render_mode="svg", default_panel_position="none")
