...
## Description
Add the src directory to the Python path Construct the path to the SVG template Initialize Sivo from the SVG Enable general features Map the different loading animations Map an "on load" animation Save to an interactive HTML file
