...
def create_card_sivo(id_str, title, value, body, color, url=None):
    ...
    s.add_card(element_id=id_str, title=display_title, subtitle=display_subtitle, value=value, body=body, left="0%", top="0%", width="100%", height="100%", shape="ellipse", bg_color=color, url=url, title_color="#ffffff", subtitle_color="#ffffff", body_color="#ffffff", html_body=True)
    return s
