...
dashboard.add_sivo_block("card1", create_card_sivo("c1", "Reduce erosion", "", "Chat to Horizons’ Land Management Advisors for advice on erosion-prone land use.", "#007DA3", url="https://www.horizons.govt.nz/managing-natural-resources/land#:~:text=Get%20in%20touch%20with%20your%20LMA,LAND%20MANAGEMENT%20TEAMS%20MAP"), col_span=1, grid_area="card1", min_height="250px")
dashboard.add_sivo_block("card2", create_card_sivo("c2", "Enhance biodiversity", "", "Protect and restore local biodiversity by fencing bush remnants, planting native vegetation, and joining community conservation efforts.", "#00A79E", url="https://enm.org.nz/"), col_span=1, grid_area="card2", min_height="250px")
dashboard.add_sivo_block("card3", create_card_sivo("c3", "Manage nutrients wisely", "", "Reach out to Horizons’ Rural Advice team for advice on improving on-farm nutrient management.", "#459461", url="https://www.horizons.govt.nz/managing-natural-resources/rural-advice"), col_span=1, grid_area="card3", min_height="250px")
dashboard.add_sivo_block("card4", create_card_sivo("c4", "Strengthen biosecurity", "", "Report pest plants and animals to Horizons’ Pest Management teams and work with neighbours on coordinated pest control.", "#283244", url="https://www.horizons.govt.nz/managing-natural-resources/plant-animal-pests"), col_span=1, grid_area="card4", min_height="250px")
dashboard.add_sivo_block("card5", create_card_sivo("c5", "Apply for a grant", "", "You might be eligible for funding through Horizons initiatives such as the Priority Habitats Programme or SLUI, or through a community grant.", "#772981", url="https://www.horizons.govt.nz/about-our-region-and-council/grants-and-sponsorship/biodiversity-grants"), col_span=1, grid_area="card5", min_height="250px")
dashboard.add_sivo_block("card6", create_card_sivo("c6", "Learn more", "", "Explore the state of the region’s environment in more detail in the report: Te Oranga o te Taiao | State of the Environment – Horizons Region", "#007DA3", url="https://www.horizons.govt.nz/HRC/media/Media/State-of-the-Environment-Horizons-Region-2025.pdf"), col_span=1, grid_area="card6", min_height="250px")
