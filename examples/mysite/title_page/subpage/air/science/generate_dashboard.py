...
<div style="font-size: 14px; color: #555; margin-top: 10px;">Trend rate: <strong>{t_trend_rate}</strong> &mu;g/m&sup3 per year;</div>
</div>
<div style="padding: 20px; background: rgba(255, 255, 255, 0.5); border-radius: 10px; width: 100%; max-width: 350px;">
...
<div style="font-size: 14px; color: #555; margin-top: 10px;">Trend rate: <strong>{tau_trend_rate}</strong> &mu;g/m&sup3 per year;</div>
</div>
...
<h3 style="margin-bottom: 5px; font-size: 16px; color: #333;">Taihape PM<sub>10</sub> exceedances over the last 5 years</h3>
<div style="font-size: 64px; font-weight: bold; color: {t_5yr_color};">{t_5yr}</div>{get_subtext(t_date, t_5yr)}</div>
<div style="padding: 20px; background: rgba(255, 255, 255, 0.5); border-radius: 10px;">
<h3 style="margin-bottom: 5px; font-size: 16px; color: #333;">Taihape PM<sub>10</sub> exceedances last year (2025)</h3>
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; text-align: center;">
<div style="padding: 20px; background: rgba(255, 255, 255, 0.5); border-radius: 10px;">
<h3 style="margin-bottom: 5px; font-size: 16px; color: #333;">Taumarunui PM<sub>10</sub> exceedances over the last 5 years</h3>
<div style="font-size: 64px; font-weight: bold; color: {tau_5yr_color};">{tau_5yr}</div>{get_subtext(tau_date, tau_5yr)}</div>
<div style="padding: 20px; background: rgba(255, 255, 255, 0.5); border-radius: 10px;">
<h3 style="margin-bottom: 5px; font-size: 16px; color: #333;">Taumarunui PM<sub>10</sub> exceedances last year (2025)</h3>
