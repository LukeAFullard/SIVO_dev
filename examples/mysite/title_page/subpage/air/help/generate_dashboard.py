...
bad_air.map(element_id="burnoff", tooltip="Click me!", glow=True, fade_pulse=True, hover_color="rgba(255, 255, 255, 0.8)", markdown=read_md("burnoff"), border_color="yellow", border_width=3)
bad_air.map(element_id="vehicle", tooltip="Click me!", glow=True, fade_pulse=True, hover_color="rgba(255, 255, 255, 0.8)", markdown=read_md("vehicle"), border_color="yellow", border_width=3)
bad_air.map(element_id="wet_wood", tooltip="Click me!", glow=True, fade_pulse=True, hover_color="rgba(255, 255, 255, 0.8)", markdown=read_md("wet_wood"), border_color="yellow", border_width=3)
bad_air.map(element_id="bad_fireplace", tooltip="Click me!", glow=True, fade_pulse=True, hover_color="rgba(255, 255, 255, 0.8)", markdown=read_md("bad_fireplace"), border_color="yellow", border_width=3)
...
good_air.map(element_id="Good_fireplace", tooltip="Click me!", glow=True, fade_pulse=True, hover_color="rgba(255, 255, 255, 0.8)", markdown=read_md("Good_fireplace"), border_color="yellow", border_width=3)
good_air.map(element_id="split_wood", tooltip="Click me!", glow=True, fade_pulse=True, hover_color="rgba(255, 255, 255, 0.8)", markdown=read_md("split_wood"), border_color="yellow", border_width=3)
good_air.map(element_id="good_transport", tooltip="Click me!", glow=True, fade_pulse=True, hover_color="rgba(255, 255, 255, 0.8)", markdown=read_md("good_transport"), border_color="yellow", border_width=3)
good_air.map(element_id="outside_wood", tooltip="Click me!", glow=True, fade_pulse=True, hover_color="rgba(255, 255, 255, 0.8)", markdown=read_md("outside_wood"), border_color="yellow", border_width=3)
good_air.map(element_id="heatpump", tooltip="Click me!", glow=True, fade_pulse=True, hover_color="rgba(255, 255, 255, 0.8)", markdown=read_md("heatpump"), border_color="yellow", border_width=3)
