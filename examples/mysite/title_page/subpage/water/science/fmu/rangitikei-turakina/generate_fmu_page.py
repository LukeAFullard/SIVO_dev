...
for folder, p_info in parameters_state.items():
    ...
    fmu_data = state_summary["FMUs"]["Rangit\u012bkei-Turakina"][p_info["json_key"]]
...
for folder, json_key in parameters_trend.items():
    fmu_data = trend_data['FMUs']['Rangit\u012bkei-Turakina'][json_key]
...
ammo_fmu_data = trend_data['FMUs']['Rangit\u012bkei-Turakina']["Ammoniacal Nitrogen (NH4)"]
ammo_region_data = trend_data['Region']["Ammoniacal Nitrogen (NH4)"]
nitrate_fmu_data = trend_data['FMUs']['Rangit\u012bkei-Turakina']["Nitrate Nitrogen (NO3)"]
