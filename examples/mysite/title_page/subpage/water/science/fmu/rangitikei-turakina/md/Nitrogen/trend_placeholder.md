...
We evaluated 10-year trends for nitrate and ammoniacal nitrogen at 24 monitoring sites across the Rangitīkei-Turakina FMU.
...
Trends show us if nitrogen levels are consistently changing over time. We use a 10-year timeframe to see past temporary weather spikes and uncover the true, long-term direction of water quality.
...
<table style="width: 100%; border-collapse: collapse; text-align: center;">
  <thead>
    <tr>
      <th style="text-align: left; padding: 8px; border-bottom: 2px solid #ddd;">Ammoniacal-N (10-year trend)</th>
  ...
  <tbody>
    <tr>
      ...
      <td style="padding: 8px; border-bottom: 1px solid #ddd; background-color: #2abeff; color: black;">33.33% (8)</td>
      <td style="padding: 8px; border-bottom: 1px solid #ddd; background-color: #e6e600; color: black;">12.5% (3)</td>
      <td style="padding: 8px; border-bottom: 1px solid #ddd; background-color: #ff6767; color: black;">54.17% (13)</td>
    </tr>
    <tr>
...
<table style="width: 100%; border-collapse: collapse; text-align: center;">
  <thead>
    <tr>
      <th style="text-align: left; padding: 8px; border-bottom: 2px solid #ddd;">Nitrate-N (10-year trend)</th>
      <th style="padding: 8px; border-bottom: 2px solid #ddd; background-color: #2abeff; color: black;">Improving</th>
      <th style="padding: 8px; border-bottom: 2px solid #ddd; background-color: #e6e600; color: black;">Indeterminate</th>
      <th style="padding: 8px; border-bottom: 2px solid #ddd; background-color: #ff6767; color: black;">Degrading</th>
    </tr>
  ...
  <tbody>
    <tr>
      <td style="text-align: left; padding: 8px; border-bottom: 1px solid #ddd;">Rangitīkei-Turakina FMU</td>
      <td style="padding: 8px; border-bottom: 1px solid #ddd; background-color: #2abeff; color: black;">73.91% (17)</td>
      <td style="padding: 8px; border-bottom: 1px solid #ddd; background-color: #e6e600; color: black;">8.7% (2)</td>
      <td style="padding: 8px; border-bottom: 1px solid #ddd; background-color: #ff6767; color: black;">17.39% (4)</td>
    </tr>
    <tr>
      <td style="text-align: left; padding: 8px; border-bottom: 1px solid #ddd;">Whole Region</td>
