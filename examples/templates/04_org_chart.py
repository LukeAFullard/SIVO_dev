...
def run():
    ...
    <div style='text-align: center; color: white; font-family: sans-serif;'>
        <img src='https://i.pravatar.cc/100' alt='CEO' style='border-radius: 50%; border: 3px solid white; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.3); width: 60px; height: 60px;'/>
    </div>
    """
    app.add_overlay(
        "poly-tier-1",
    ...
    app.add_overlay(
        "poly-tier-2",
        "<div style='text-align: center; color: white; font-family: sans-serif; font-size: 20px; font-weight: 600;'>VPs & Directors</div>",
        offset_y=10
    )

    markdown_side = """
    <div style='font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; padding: 20px;'>
        <h1 style='color: #1e293b; margin-top:0;'>Corporate Structure</h1>
