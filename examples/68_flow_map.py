...
def create_example():
    ...
    flow_data = [
        {"origin": "Hub1", "destination": "Hub4", "value": 3200, "label": "SEA-JFK", "color": "#38bdf8"},
        {"origin": "Hub1", "destination": "Hub2", "value": 1500, "color": "#38bdf8"},
        {"origin": "Hub4", "destination": "Hub3", "value": 2800, "label": "JFK-ORD", "color": "#fbbf24"},
        {"origin": "Hub3", "destination": "Hub2", "value": 900, "color": "#fbbf24"},
        {"origin": "Hub2", "destination": "Hub1", "value": 1200, "color": "#a3e635"}
    ]

    app.apply_flow_map(flow_data, min_width=1.0, max_width=6.0, flow_effect=True, effect_symbol="arrow", animation_speed=2.0)

    html_output = "examples/68_flow_map.html"
