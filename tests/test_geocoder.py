...
class TestGeocoder(unittest.TestCase):
    ...
    def test_photon_provider_with_country_code(self):
        svg_content = """
        <svg xmlns="http://www.w3.org/2000/svg">
            <rect id="rect1" x="10" y="20" width="30" height="40"/>
        </svg>
        ...
        sivo_app = Sivo.from_string(
            ...
            geocode_country_codes="nz,au"
        )

        self.assertEqual(sivo_app.infographic.geocode_country_codes, "nz,au")
        html_output = sivo_app.to_html()

        # We know nz coords should be included in JS if nz is first
        self.assertIn("-40.9006", html_output)
