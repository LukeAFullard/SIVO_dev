...
class LoadingAction(BaseAction):
    ...
    style: Literal["spinner", "pulse", "typewriter", "shimmer", "glitch", "matrix", "bouncing_dots", "ripple", "radar", "neon", "typing_indicator", "progress_bar", "heartbeat", "slot_machine", "orbit", "breathe"] = Field(default="spinner", description="Visual style of the loading animation")
